...
func IngressProtocolVariantSpecData(ingressProtocolVariantSpecData string) map[string]string {
	...
	subfields := []string{
		...
		"IPVSD_Blank_Field",
		"IPVSD_SIP_T_Version",
		"IPVSD_SIP_URI_PAI_Display_Name",
		"IPVSD_P_K_CallFwdLast_User_Param",
		"IPVSD_SIP_Req_URI_User_Host",
		"IPVSD_SIP_URI_PAI_User_Host",
		"IPVSD_Proxy_Auth_Username",
		"IPVSD_Tel_URI_PAI_Display_Name",
		"IPVSD_Invite_Contact_Header",
		"IPVSD_200_OK_Invite_Contact_Header",
		"IPVSD_P_K_CallFwdOrig_Redir_Reason",
		"IPVSD_Tel_URI_PAI_User_Name",
		"IPVSD_P_Sig_Info_Contractor_Num",
		"IPVSD_ACK_Rxd_for_200_OK",
		...
		"IPVSD_Feature_Tag_Accept_Contact",
		"IPVSD_P_Charging_Function_Address",
		"IPVSD_P_Called_Party_Id",
		"IPVSD_P_Visited_Network_Id",
...
//SIP,b10e953ce9b911e298a600151737326e@204.124.15.58,<sip:7875315936@204.124.15.58:5065;user=phone>;tag=177540785-3792812521-352364184-1848784663,<sip:19106333559@76.10.220.14;user=phone>;tag=gK00f27408,0,,,,sip:19106333559@76.10.220.14;user=phone,,,,sip:7875315936@204.124.15.58:5065;user=phone,sip:19106333559@76.10.220.14:5060,,,,1,BYE,16,0,0,,0,0,,,,,,,,1,0,0,0,,
func EgressProtocolVariantSpecData(egressProtocolVariantSpecData string) map[string]string {
	...
	subfields := []string{
		...
		"EPVSD_Blank_Field",
		"EPVSD_SIP_T_Version",
		"EPVSD_SIP_URI_PAI_Display_Name",
		"EPVSD_P_K_CallFwdLast_User_Param",
		"EPVSD_SIP_Req_URI_User_Host",
		"EPVSD_SIP_URI_PAI_User_Host",
		"EPVSD_Proxy_Auth_Username",
		"EPVSD_Tel_URI_PAI_Display_Name",
		"EPVSD_Invite_Contact_Header",
		"EPVSD_200_OK_Invite_Contact_Header",
		"EPVSD_P_K_CallFwdOrig_Redir_Reason",
		"EPVSD_Tel_URI_PAI_User_Name",
		"EPVSD_P_Sig_Info_Contractor_Num",
		"EPVSD_ACK_Rxd_for_200_OK",
		...
		"EPVSD_Feature_Tag_Accept_Contact",
		"EPVSD_P_Charging_Function_Address",
		"EPVSD_P_Called_Party_Id",
		"EPVSD_P_Visited_Network_Id",
